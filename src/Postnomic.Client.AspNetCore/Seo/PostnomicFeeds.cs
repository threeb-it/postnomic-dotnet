...
public static class PostnomicFeeds
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return BuildSitemapXml(posts, request, basePath, style);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return BuildRssXml(page.Items, request, basePath, style, channelTitle, channelDescription);
    }
        ...
        string? channelDescription)
    {
        ...
        foreach (var post in posts)
        {
            var link = ToAbsoluteUrl(request, PostnomicRouteBuilder.BuildPost(basePath, style, post.Language, post.Slug));
    ...
    {
        var loc = ToAbsoluteUrl(request, PostnomicRouteBuilder.BuildPost(basePath, style, post.Language, post.Slug));
        ...
        {
            var altUrl = ToAbsoluteUrl(request, PostnomicRouteBuilder.BuildPost(basePath, style, lang, post.Slug));
