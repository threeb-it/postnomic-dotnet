...
/// inline SVG glyph, used by every Blazor component's Semantic-mode icon rendering. Kept in one
/// place — rather than duplicated per component — so Semantic-mode consumers (e.g. OutaStory) get
/// visually distinguishable icons instead of one generic placeholder repeated everywhere.
/// </summary>
/// <remarks>
...
internal static class PostnomicIcons
{
    ...
    /// </summary>
    public static string Markup(string bootstrapIconClass)
    {
